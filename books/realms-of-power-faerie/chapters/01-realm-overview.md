...
title: 'Realms of Power: Faerie - Realm Overview'
published: true
...
This placeholder validates the third pilot route and keeps the pilot set aligned with the PDFs currently staged in `_books`.
